...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/DSL_2_F-RMQ_and_RUQ.lazysegtree.test.cpp\"\n#include\
    ...
    \                return r + 1 - size;\n            }\n            sm = op(dat[r],\
    \ sm);\n        } while ((r & -r) != r);\n        return 0;\n    }\n}; // LazySegmentTree\n\
    #line 4 \"test/aoj/DSL_2_F-RMQ_and_RUQ.lazysegtree.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/problems/DSL_2_F\"\nconst int INF = INT32_MAX;\n\
    const int ID = INT32_MAX;\n\nusing S = int;\nusing F = int;\n\nS op(S a, S b)\
    \ { return min(a, b); }\nS e() { return INF; }\nS mapping(F f, S x) { return (f\
    \ == ID ? x:f); }\nF composition(F f, F g) { return (f == ID ? g:f); }\nF id()\
    \ { return ID; }\n\nint main() {\n    ios_base::sync_with_stdio(0);\n    int n,\
    \ q;\n    cin>>n>>q;\n    vector<S> v(n, INF);\n    LazySegmentTree<S, op, e,\
    \ F, mapping, composition, id> seg(v);\n    while(q--) {\n        int typ, a,\
    \ b;\n        cin>>typ>>a>>b;\n        if(typ==0) {\n            int x;\n    \
    \        cin>>x;\n            seg.apply(a, b+1, x);\n        } else {\n      \
    \      cout<<seg.prod(a, b+1)<<'\\n';\n        }\n    }\n    return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/aoj/DSL_2_F-RMQ_and_RUQ.lazysegtree.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/DSL_2_F-RMQ_and_RUQ.lazysegtree.test.cpp
- /verify/test/aoj/DSL_2_F-RMQ_and_RUQ.lazysegtree.test.cpp.html
