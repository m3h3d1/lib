...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/CGL_2_B-Intersection.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/problems/CGL_2_B\"\n#include <bits/stdc++.h>\n\
    ...
    \ a.a), distance_sp(b, a.b)});\n}\n#line 5 \"test/aoj/CGL_2_B-Intersection.test.cpp\"\
    \n\nint main() {\n    ios_base::sync_with_stdio(0);\n    int q;\n    cin>>q;\n\
    \    while(q--) {\n        Point p0, p1, p2, p3;\n        cin>>p0>>p1>>p2>>p3;\n\
    \        Line l1 = Line(p0, p1);\n        Line l2 = Line(p2, p3);\n\n        if(is_intersect_ss(l1,\
    \ l2)) {\n            cout<<\"1\\n\";\n        } else {\n            cout<<\"\
    0\\n\";\n        }\n    }\n    return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/aoj/CGL_2_B-Intersection.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/CGL_2_B-Intersection.test.cpp
- /verify/test/aoj/CGL_2_B-Intersection.test.cpp.html
