...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/DSL_2_E-RAQ.segtree.test.cpp\"\n#include <bits/stdc++.h>\n\
    ...
    \        lz[k] = id();\n    }\n    int lower_bits(int x, int k) { return x & ((1\
    ...
    \                  }\n                }\n                return r + 1 - size;\n\
    \            }\n            sm = op(dat[r], sm);\n        } while ((r & -r) !=\
    \ r);\n        return 0;\n    }\n}; // LazySegmentTree\n#line 4 \"test/aoj/DSL_2_E-RAQ.segtree.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/aoj/DSL_2_E-RAQ.segtree.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/DSL_2_E-RAQ.segtree.test.cpp
- /verify/test/aoj/DSL_2_E-RAQ.segtree.test.cpp.html
