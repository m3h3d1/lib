...
data:
  ...
  code: "#include \"2dPointAndVector.hpp\"\n\nbool is_orthogonal(const Line& a, const\
    ...
    \ m.a + (m.b - m.a) * B / A;\n}\n\nReal distance_sp(const Segment& s, const Point&\
...
layout: document
redirect_from:
- /library/geometry/2dSegmentAndLine.hpp
- /library/geometry/2dSegmentAndLine.hpp.html
